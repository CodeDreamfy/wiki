+ function(){
    ...
    function adaptUILayout(){
        ...
        initialContent   = isiOS 
            //? 'width=' + 640 + ', user-scalable=no,initial-scale=1,maximum-scale=1, minimal-ui'
            ? 'width=' + 640 + ', user-scalable=no, minimal-ui'
            : 'target-densitydpi=' + targetDensitydpi + ', width='+ 640 +', user-scalable=no,initial-scale=1,maximum-scale=1, minimal-ui';
